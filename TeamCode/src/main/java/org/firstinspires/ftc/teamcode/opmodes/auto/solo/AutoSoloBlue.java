...
@Config
@Autonomous(name = "Auto (Solo)(Blue)", group = "Competition", preselectTeleOp = "TeleOpTuner")
public class AutoSoloBlue extends CommandOpMode {
    ...
    private SequentialCommandGroup buildAutoSequence() {
        return new SequentialCommandGroup(
                ...
                new FollowPathCommand(robot.follower, paths.spikeIV),
                new ParallelDeadlineGroup(
                        new FollowPathCommand(robot.follower, paths.intakeSpikeIV),
                        new IntakeCommand(robot.intake, ()-> true)
                ),
                new DriveAndAim(robot, paths.shootAfterSpikeIV),
                shootAndClean(),
