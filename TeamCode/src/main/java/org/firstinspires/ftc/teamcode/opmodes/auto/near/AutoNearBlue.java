...
import org.firstinspires.ftc.teamcode.opmodes.auto.path.AutoPathNear;
import org.firstinspires.ftc.teamcode.util.PedroDrawing;

@Config
@Autonomous(name = "Auto (Close)(Blue)", group = "Competition", preselectTeleOp = "TeleOpTuner")
public class AutoNearBlue extends CommandOpMode {
    ...
    public void initialize() {
        ...
        paths = new AutoPathNear(robot.follower);
    ...
    private SequentialCommandGroup buildAutoSequence() {
        return new SequentialCommandGroup(
                ...
                new DriveAndAim(robot, paths.shootAfterSpike3),
                shootAndClean(),
                ...
                new FollowPathCommand(robot.follower, paths.openGate2).setGlobalMaxPower(0.3),
                new DriveAndAim(robot, paths.shootAfterSpike2),
                shootAndClean(),
                ...
                new DriveAndAim(robot, paths.shootAfterSpike1),
                shootAndClean(),
    ...
    //deubg function：只有在 DEBUG_MODE 為 true 時才會等待按鍵
    ...
    private void updateTelemetry() {
        ...
        telemetry.addLine("\n=== ⚙️ Subsystems ===");
        // 確保變數名稱與 Robot 類別一致 (假設是 shooterSystem)
