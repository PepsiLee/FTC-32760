...
@Config
@Autonomous(name = "Auto (Near Open Gate)(Blue)", group = "Competition", preselectTeleOp = "TeleOpTuner")
public class AutoNearOpenGateBlue extends CommandOpMode {
    ...
    private SequentialCommandGroup buildAutoSequence() {
        return new SequentialCommandGroup(
                ...
                new DriveAndAim(robot, paths.shootAfterSparkIII),
                shootAndClean(),
